...
<footer className=" ">
  ...
  >
    <div class="grid mt-4 grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <a href='#' className={`text-3xl font-bold font-heading flex items-center ${isDarkMode ? 'text-black' : 'text-white' } `}> <span className='text-orange-700'>Cr</span>icS < BiCricketBall/></a>
        ...
        <p class="mt-4 max-w-xs text-gray-500">
          Get Live Cricket Update, fast and reliable.
        </p>
      ...
      >
        ...
        <div>
          <p className={`font-medium ${isDarkMode ? 'text-black' : 'text-white' } `}>Company</p>
        ...
        <div>
          <p className={`font-medium ${isDarkMode ? 'text-black' : 'text-white' } `}>Helpful Links</p>
        ...
        <div>
          <p className={`font-medium ${isDarkMode ? 'text-black' : 'text-white' } `}>Legal</p>
    ...
    <p class="text-xs text-gray-500">
      &copy; 2023. Crics. All rights reserved.
    </p>
  </div>
</footer>
    );
